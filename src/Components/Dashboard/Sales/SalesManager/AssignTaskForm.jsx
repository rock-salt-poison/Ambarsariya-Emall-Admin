...
import { get_permissions, get_staff_types, get_staff_with_type, get_userByToken, post_create_staff, post_create_staff_tasks, post_staff_email_otp, post_verify_staff_email_otp, send_otp_to_email } from '../../../../API/expressAPI';
...
const AssignTaskForm = () => {
  ...
  const formFields = [
    ...
    { id: 5, label: 'Location', name: 'location', type: 'address',cName:'flex-1', readOnly: true},
    ...
    { id: 10, label: 'Assign Daily Task', name: 'assign_daily_task', type: 'text' },
    { id: 11, label: 'Choose Date', name: 'daily_task_date', type: 'date' ,cName:'flex-auto' },
    { id: 12, label: 'Daily location', name: 'daily_location', type: 'address', cName:'flex-auto' },
  ];
